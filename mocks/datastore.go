...
// GetParticipantByDiscussionIDParticipantID provides a mock function with given fields: ctx, discussionID, participantID
func (_m *Datastore) GetParticipantByDiscussionIDParticipantID(ctx context.Context, discussionID string, participantID int) (*model.Participant, error) {
	ret := _m.Called(ctx, discussionID, participantID)

	var r0 *model.Participant
	if rf, ok := ret.Get(0).(func(context.Context, string, int) *model.Participant); ok {
		r0 = rf(ctx, discussionID, participantID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*model.Participant)
		}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, string, int) error); ok {
		r1 = rf(ctx, discussionID, participantID)
	} else {
		r1 = ret.Error(1)
	}
