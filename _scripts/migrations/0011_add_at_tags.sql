...
ALTER TABLE mentions
    ADD CONSTRAINT mentions_participants_fk_fdc1b4ef8382 FOREIGN KEY (participant_id) REFERENCES participants (id) MATCH FULL,
    ADD CONSTRAINT mentions_post_contents_fk_a8bf8f3fa1b8 FOREIGN KEY (post_content_id) REFERENCES post_contents (id) MATCH FULL;
